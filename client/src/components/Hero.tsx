...
const DEMO_VIDEO_URL =
  "https://cdn.dribbble.com/userupload/46586329/file/bb95c66489817d863688b9b8ca9f12d0.mp4";
      ...
      <div className="relative pt-20 pb-16 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto text-center relative z-20">
          ...
          <p className="z-30 text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            account and go live in minutes. No configuration nightmares.
          </p>
          ...
          <div className="z-30 flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
            ...
            >
              <Play size={18} fill="currentColor" aria-hidden="true" /> Watch
              Demo
            </button>
          </div>
  ...
  switch (line.type) {
    ...
    case "success":
      return (
        <div
          key={index}
          className="flex items-center gap-3 text-foreground animate-fadeIn"
        >
          <CheckCircle2
            size={16}
...
export const DeploymentTerminal = memo<DeploymentTerminalProps>(
  ({ terminalLines }) => {
    const showProcessing =
      terminalLines.length > 0 && terminalLines.length < PROCESSING_THRESHOLD;
