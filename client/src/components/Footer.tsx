            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    <div className="flex items-start justify-start flex-col col-span-1 md:col-span-2">
                        ...
                        <div className="flex gap-4">
                            <Link target='_blank' to="https://twitter.com/ahmedg3far44" className="p-2 bg-secondary rounded-lg hover:bg-secondary/80 transition-colors text-muted-foreground hover:text-foreground">
                                <Twitter size={20} />
                            </Link>
                            <Link target='_blank' to="https://github.com/ahmedG3far44" className="p-2 bg-secondary rounded-lg hover:bg-secondary/80 transition-colors text-muted-foreground hover:text-foreground">
                                <Github size={20} />
                            </Link>
                            <Link target='_blank' to="https://www.linkedin.com/in/ahmedg3far44/" className="p-2 bg-secondary rounded-lg hover:bg-secondary/80 transition-colors text-muted-foreground hover:text-foreground">
                                <Linkedin size={20} />
                            </Link>
                        </div>
                    </div>
                ...
                <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-muted-foreground text-sm">
                        © {new Date().getFullYear()} DevPilot. All rights reserved. Built by developer <Link className="text-primary hover:underline" target='_blank' to="https://www.linkedin.com/in/ahmedg3far44/">Ahmed G3far</Link> for developers.
                    </p>
